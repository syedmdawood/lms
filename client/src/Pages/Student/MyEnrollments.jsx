...
const MyEnrollments = () => {
  ...
  const [progressArray, setProgressArray] = useState([
    ...
    { lectureCompleted: 8, totalLecture: 9 },
          ...
          <tbody className="text-gray-700">
            {enrolledCourses.map((course, index) => (
              <tr key={index} className="border-b border-gray-500/20">
                <td className="md:px-4 pl-2 md:pl-4 py-3 flex items-center space-y-3">
                  <img
                  ...
                  <div className="flex-1">
                    <p className="mb-1 pl-3 max-sm:text-sm">
                      {course.courseTitle}
                    </p>
                    <Line
                      strokeWidth={2}
                      ...
                      className="bg-gray-300 rounded-full ml-3"
                    />
                  </div>
                </td>
