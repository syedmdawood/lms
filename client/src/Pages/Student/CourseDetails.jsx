...
const CourseDetails = () => {
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-28 px-8 md:pt-18 pt-14 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <div className="flex items-center space-x-2 pt-3 pb-1 text-sm">
            <p>{calculateRaing(courseData)}</p>
            <div className="flex">
              {[...Array(5)].map((_, i) => (
                <img
                  key={i}
                  src={
                    i < Math.floor(calculateRaing(courseData))
                      ? assets.star
                      : assets.star_blank
                  }
            ...
            <p>
              {courseData?.enrolledStudensts?.length}{" "}
              {courseData?.enrolledStudensts?.length > 1
                ? "students"
                : "student"}
            </p>
          </div>
          ...
          <div className="p-5">
            ...
            <div className="pt-6 ">
              ...
              <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                ...
                <li>Downloadable resouses and sourse code.</li>
